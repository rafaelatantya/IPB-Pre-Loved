            ...
            {wishlistItems.map((item) => (
              <div key={item.id} className="relative group">
                ...
                <button 
                  ...
                  disabled={isPending}
                  className="absolute -top-2 -right-2 p-2 bg-white border border-red-100 text-red-500 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transition-all hover:bg-red-500 hover:text-white z-20"
