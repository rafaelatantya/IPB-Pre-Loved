...
-- 3. PRODUCTS (15 Entri)
INSERT INTO products (id, seller_id, category_id, title, description, price, condition, status, location, video_url, video_duration, created_at) VALUES 
('p-1', 'user-seller-1', 'cat-elek', 'MacBook Air M1 2020 Space Grey', 'Barang simpanan, mulus 99%. Fullset original.', 9500000, 'LIKE_NEW', 'APPROVED', 'DRAMAGA', '/api/images/products/video_1.mp4', 10, 1767225600000),
('p-2', 'user-seller-1', 'cat-buku', 'Buku Koding Python Dasar', 'Buku wajib buat yang mau belajar AI.', 120000, 'NEW', 'APPROVED', 'BARANANGSIANG', NULL, NULL, 1767966171000),
('p-3', 'user-seller-1', 'cat-kost', 'Meja Lipat Kayu Pinus', 'Cocok buat kamar sempit. Bisa dilipat rapi.', 50000, 'CUKUP', 'APPROVED', 'CILIBENDE', '/api/images/products/video_2.mp4', 8, 1768706742000),
('p-4', 'user-seller-2', 'cat-elek', 'Lampu Meja LED Eye-Care', 'Terang tapi nggak bikin mata sakit.', 85000, 'LIKE_NEW', 'APPROVED', 'DRAMAGA', NULL, NULL, 1769447314000),
('p-5', 'user-seller-2', 'cat-prak', 'Kalkulator Casio FX-991EX', 'Kalkulator saintifik buat anak teknik/sains.', 250000, 'GOOD', 'APPROVED', 'BARANANGSIANG', NULL, NULL, 1770187885000),
('p-6', 'user-seller-1', 'cat-prak', 'Jas Lab Ukuran L', 'Jas lab bersih, baru dipake 1 semester praktikum.', 75000, 'GOOD', 'APPROVED', 'DRAMAGA', NULL, NULL, 1770928457000),
('p-7', 'user-seller-2', 'cat-fash', 'Sepatu Pantofel Hitam 42', 'Sepatu formal buat sidang atau wisuda.', 150000, 'LIKE_NEW', 'APPROVED', 'CILIBENDE', '/api/images/products/video_3.mp4', 12, 1771669028000),
('p-8', 'user-seller-1', 'cat-kost', 'Kipas Angin Miyako Kecil', 'Bikin adem kostan, suara mesin halus.', 110000, 'GOOD', 'APPROVED', 'BARANANGSIANG', NULL, NULL, 1772409600000),
('p-9', 'user-seller-2', 'cat-elek', 'Headset Logitech G335', 'Mantap buat dengerin materi atau gaming.', 450000, 'LIKE_NEW', 'APPROVED', 'DRAMAGA', NULL, NULL, 1773150171000),
